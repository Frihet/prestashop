...
CREATE TABLE `PREFIX_accessory` (
  ...
  FOREIGN KEY `accessory_product_1` (`id_product_1`) REFERENCES `PREFIX_product_1` (`id_product_1`),
  FOREIGN KEY `accessory_product_2` (`id_product_2`) REFERENCES `PREFIX_product_2` (`id_product_2`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `PREFIX_address` (
  ...
  FOREIGN KEY `address_customer` (`id_customer`) REFERENCES `PREFIX_customer` (`id_customer`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `PREFIX_attribute` (
  ...
  FOREIGN KEY `attribute_group` (`id_attribute_group`) REFERENCES `PREFIX_attribute_group` (`id_attribute_group`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `PREFIX_attribute_impact` (
  ...
  FOREIGN KEY `id_product_1` (`id_product`) REFERENCES `PREFIX_product` (`id_product`),
  FOREIGN KEY `id_product_2` (`id_attribute`) REFERENCES `PREFIX_attribute` (`id_attribute`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `PREFIX_attribute_lang` (
  ...
  FOREIGN KEY `id_lang_1` (`id_lang`) REFERENCES `PREFIX_lang` (`id_lang`),
  KEY `id_lang_2` (`name`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `PREFIX_carrier` (
  ...
  KEY `deleted_1` (`deleted`),
  KEY `deleted_2` (`active`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `PREFIX_carrier_lang` (
  ...
  FOREIGN KEY `shipper_lang_index_1` (`id_lang`) REFERENCES `PREFIX_lang` (`id_lang`),
  FOREIGN KEY `shipper_lang_index_2` (`id_carrier`) REFERENCES `PREFIX_carrier` (`id_carrier`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `PREFIX_cart` (
  ...
  `date_upd` datetime NOT NULL,
  PRIMARY KEY  (`id_cart`),
  FOREIGN KEY `cart_customer` (`id_customer`) REFERENCES `PREFIX_customer` (`id_customer`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

CREATE TABLE `PREFIX_cart_discount` (
  `id_cart` int(10) unsigned NOT NULL,
  `id_discount` int(10) unsigned NOT NULL,
  FOREIGN KEY `cart_discount_index_1` (`id_cart`) REFERENCES `PREFIX_cart` (`id_cart`),
  FOREIGN KEY `cart_discount_index_2` (`id_discount`) REFERENCES `PREFIX_discount` (`id_discount`),
  FOREIGN KEY `id_discount` (`id_discount`) REFERENCES `PREFIX_discount` (`id_discount`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `PREFIX_cart_product` (
  ...
  `date_add` datetime NOT NULL,
  FOREIGN KEY `cart_product_index_1` (`id_cart`) REFERENCES `PREFIX_cart` (`id_cart`),
  FOREIGN KEY `cart_product_index_2` (`id_product`) REFERENCES `PREFIX_product` (`id_product`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `PREFIX_category` (
  ...
  FOREIGN KEY `category_parent` (`id_parent`) REFERENCES `PREFIX_parent` (`id_parent`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

CREATE TABLE `PREFIX_category_group` (
  `id_category` int(10) unsigned NOT NULL,
  `id_group` int(10) unsigned NOT NULL,
  FOREIGN KEY `category_group_index_1` (`id_category`) REFERENCES `PREFIX_category` (`id_category`),
  FOREIGN KEY `category_group_index_2` (`id_group`) REFERENCES `PREFIX_group` (`id_group`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `PREFIX_category_lang` (
  ...
  FOREIGN KEY `category_lang_index_1` (`id_category`) REFERENCES `PREFIX_category` (`id_category`),
  FOREIGN KEY `category_lang_index_2` (`id_lang`) REFERENCES `PREFIX_lang` (`id_lang`),
...
CREATE TABLE `PREFIX_category_product` (
  ...
  FOREIGN KEY `category_product_index_1` (`id_category`) REFERENCES `PREFIX_category` (`id_category`),
  FOREIGN KEY `category_product_index_2` (`id_product`) REFERENCES `PREFIX_product` (`id_product`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `PREFIX_connections` (
  ...
  FOREIGN KEY `id_guest` (`id_guest`) REFERENCES `PREFIX_guest` (`id_guest`),
...
CREATE TABLE `PREFIX_connections_source` (
  ...
  FOREIGN KEY `connections` (`id_connections`) REFERENCES `PREFIX_connections` (`id_connections`),
...
CREATE TABLE `PREFIX_contact_lang` (
  ...
  `name` varchar(32) NOT NULL,
  `description` text,
  FOREIGN KEY `contact_lang_index_1` (`id_contact`) REFERENCES `PREFIX_contact` (`id_contact`),
  FOREIGN KEY `contact_lang_index_2` (`id_lang`) REFERENCES `PREFIX_lang` (`id_lang`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `PREFIX_country` (
  ...
  FOREIGN KEY `country_` (`id_zone`) REFERENCES `PREFIX_zone` (`id_zone`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `PREFIX_country_lang` (
  ...
  `id_lang` int(10) unsigned NOT NULL,
  `name` varchar(64) NOT NULL,
  FOREIGN KEY `country_lang_index_1` (`id_country`) REFERENCES `PREFIX_country` (`id_country`),
  FOREIGN KEY `country_lang_index_2` (`id_lang`) REFERENCES `PREFIX_lang` (`id_lang`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `PREFIX_customer` (
  ...
  KEY `customer_login_1` (`email`),
  KEY `customer_login_2` (`passwd`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `PREFIX_delivery` (
  ...
  FOREIGN KEY `id_zone` (`id_zone`) REFERENCES `PREFIX_zone` (`id_zone`),
  FOREIGN KEY `id_carrier_1` (`id_carrier`) REFERENCES `PREFIX_carrier` (`id_carrier`),
  FOREIGN KEY `id_carrier_2` (`id_zone`) REFERENCES `PREFIX_zone` (`id_zone`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `PREFIX_discount` (
  ...
  FOREIGN KEY `discount_customer` (`id_customer`) REFERENCES `PREFIX_customer` (`id_customer`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `PREFIX_employee` (
  ...
  KEY `employee_login_1` (`email`),
  KEY `employee_login_2` (`passwd`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `PREFIX_feature_value` (
  ...
  FOREIGN KEY `feature` (`id_feature`) REFERENCES `PREFIX_feature` (`id_feature`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `PREFIX_group_lang` (
  ...
  `id_lang` int(10) unsigned NOT NULL,
  `name` varchar(32) NOT NULL,
  FOREIGN KEY `attribute_lang_index_1` (`id_group`) REFERENCES `PREFIX_group` (`id_group`),
  FOREIGN KEY `attribute_lang_index_2` (`id_lang`) REFERENCES `PREFIX_lang` (`id_lang`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `PREFIX_guest` (
  ...
  FOREIGN KEY `id_customer` (`id_customer`) REFERENCES `PREFIX_customer` (`id_customer`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `PREFIX_hook_module` (
  ...
  FOREIGN KEY `id_hook` (`id_hook`) REFERENCES `PREFIX_hook` (`id_hook`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `PREFIX_image` (
  ...
  FOREIGN KEY `image_product` (`id_product`) REFERENCES `PREFIX_product` (`id_product`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `PREFIX_image_lang` (
  ...
  FOREIGN KEY `image_lang_index_1` (`id_image`) REFERENCES `PREFIX_image` (`id_image`),
  FOREIGN KEY `image_lang_index_2` (`id_lang`) REFERENCES `PREFIX_lang` (`id_lang`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `PREFIX_message` (
  ...
  FOREIGN KEY `message_order` (`id_order`) REFERENCES `PREFIX_order` (`id_order`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `PREFIX_orders` (
  ...
  FOREIGN KEY `id_customer` (`id_customer`) REFERENCES `PREFIX_customer` (`id_customer`),
  FOREIGN KEY `id_cart` (`id_cart`) REFERENCES `PREFIX_cart` (`id_cart`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `PREFIX_order_detail` (
  ...
  FOREIGN KEY `order_detail_order` (`id_order`) REFERENCES `PREFIX_order` (`id_order`),
...
CREATE TABLE `PREFIX_order_discount` (
  ...
  FOREIGN KEY `order_discount_order` (`id_order`) REFERENCES `PREFIX_order` (`id_order`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `PREFIX_order_history` (
  ...
  FOREIGN KEY `order_history_order` (`id_order`) REFERENCES `PREFIX_order` (`id_order`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `PREFIX_order_return` (
  ...
  FOREIGN KEY `order_return_customer` (`id_customer`) REFERENCES `PREFIX_customer` (`id_customer`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `PREFIX_order_return_state_lang` (
  ...
  `id_lang` int(10) unsigned NOT NULL,
  `name` varchar(64) NOT NULL,
  FOREIGN KEY `order_state_lang_index_1` (`id_order_return_state`) REFERENCES `PREFIX_order_return_state` (`id_order_return_state`),
  FOREIGN KEY `order_state_lang_index_2` (`id_lang`) REFERENCES `PREFIX_lang` (`id_lang`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `PREFIX_order_slip` (
  ...
  FOREIGN KEY `order_slip_customer` (`id_customer`) REFERENCES `PREFIX_customer` (`id_customer`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `PREFIX_order_state_lang` (
  ...
  FOREIGN KEY `order_state_lang_index_1` (`id_order_state`) REFERENCES `PREFIX_order_state` (`id_order_state`),
  FOREIGN KEY `order_state_lang_index_2` (`id_lang`) REFERENCES `PREFIX_lang` (`id_lang`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `PREFIX_page` (
  ...
  PRIMARY KEY  (`id_page`),
  FOREIGN KEY `id_page_type` (`id_page_type`) REFERENCES `PREFIX_page_type` (`id_page_type`),
  FOREIGN KEY `id_object` (`id_object`) REFERENCES `PREFIX_object` (`id_object`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `PREFIX_product` (
  ...
  FOREIGN KEY `product_supplier` (`id_supplier`) REFERENCES `PREFIX_supplier` (`id_supplier`),
  FOREIGN KEY `product_manufacturer` (`id_manufacturer`) REFERENCES `PREFIX_manufacturer` (`id_manufacturer`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `PREFIX_product_attribute` (
  ...
  FOREIGN KEY `product_attribute_product` (`id_product`) REFERENCES `PREFIX_product` (`id_product`),
...
CREATE TABLE `PREFIX_product_attribute_image` (
  ...
  FOREIGN KEY `id_image` (`id_image`) REFERENCES `PREFIX_image` (`id_image`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `PREFIX_product_lang` (
  ...
  FOREIGN KEY `product_lang_index_1` (`id_product`) REFERENCES `PREFIX_product` (`id_product`),
  FOREIGN KEY `product_lang_index_2` (`id_lang`) REFERENCES `PREFIX_lang` (`id_lang`),
  FOREIGN KEY `id_lang` (`id_lang`) REFERENCES `PREFIX_lang` (`id_lang`),
  KEY `name` (`name`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `PREFIX_tax_lang` (
  ...
  `id_lang` int(10) unsigned NOT NULL,
  `name` varchar(32) NOT NULL,
  FOREIGN KEY `tax_lang_index_1` (`id_tax`) REFERENCES `PREFIX_tax` (`id_tax`),
  FOREIGN KEY `tax_lang_index_2` (`id_lang`) REFERENCES `PREFIX_lang` (`id_lang`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

CREATE TABLE `PREFIX_tax_state` (
  `id_tax` int(10) unsigned NOT NULL,
  `id_state` int(10) unsigned NOT NULL,
  FOREIGN KEY `tax_state_index_1` (`id_tax`) REFERENCES `PREFIX_tax` (`id_tax`),
  FOREIGN KEY `tax_state_index_2` (`id_state`) REFERENCES `PREFIX_state` (`id_state`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

CREATE TABLE `PREFIX_tax_zone` (
  `id_tax` int(10) unsigned NOT NULL,
  `id_zone` int(10) unsigned NOT NULL,
  FOREIGN KEY `tax_zone_index_1` (`id_tax`) REFERENCES `PREFIX_tax` (`id_tax`),
  FOREIGN KEY `tax_zone_index_2` (`id_zone`) REFERENCES `PREFIX_zone` (`id_zone`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
