...
<ul class="block_various_links" id="block_various_links_footer">
	<li class="first_item">
<!-- <a href="{$base_dir}prices-drop.php" title="">{l s='Specials' mod='blockvariouslinks'}</a></li>
	...
	<li class="item"> --><a href="/prestashop/contact-form.php" title="">{l s='Contact us' mod='blockvariouslinks'}</a></li>
