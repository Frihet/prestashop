...
/**
  ...
  *
  */
class productsAlsobuyRightBox extends Module
{
 	function __construct()
 	{
 	 	$this->name = 'productsalsobuyrightbox';
 	 	$this->version = '0.5';
 	 	$this->tab = 'Products';
		...
		$this->description = $this->l('Customers who bought this item also bought ... this hacked to be a right-product-pane minimal box by www.FreeCode.no, original brought to you by www.jing-shop.com ... if you like it, please consider a backlink to my shop. Thank you ');
 	}
	...
	function install()
	{
	 	if (!parent::install())
	 		return false;
	 	return $this->registerHook('extraRight');
	}
	...
	public function getContent()
	{
		...
		if (Tools::isSubmit('submitPAB'))
		{
			...
			Tools::redirectAdmin($currentIndex.'&configure=productsalsobuyrightbox&token='.Tools::getValue('token').'&conf=4');
		}
   ...
   private function getRandomProducts($id_lang)
	...
	public function hookExtraRight($params)
	{
		...
		if ($relatedProducts)
			...
			return $this->display(__FILE__, 'productsalsobuyrightbox.tpl');
		}
