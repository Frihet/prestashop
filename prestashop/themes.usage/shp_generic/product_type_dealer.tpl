...
{variablebox}
	<div id="primary_block">
		...
		<div style="float:left;width:60%;">
			...
			<a href="dealers.php?id_category={$category->id_category}" title="" class="button" style="margin-top:30px;">{l s='Go back to map view'}</a>
<!--
v.title,
...
-->
		...
		<div style="float:right;">
			...
			<h3>{l s='Find us here'}</h3>
			
			{variablebox}
			{if $product->vendor.hours}
			<b>{l s='Opening hours'}</b><br/>
			...
			<br/>
			<b>{l s='Phone'}:</b> {$product->vendor.phone}<br/>
			<b>{l s='Cell phone'}:</b> {$product->vendor.phone_mobile}<br/>
			{if $product->vendor.fax}
			<b>{l s='Fax'}:</b> {$product->vendor.fax}<br/>
			{/if}
			<br/>
			<b>{l s='E-mail'}:</b><br/>
