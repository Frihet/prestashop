	...
	<div id="order-detail-content" class="table_block">
		<table id="cart_summary" class="std">
			...
			{foreach from=$products item=product name=productLoop}
				...
				{include file=$tpl_dir./modules/wishlist/wishlist-product-line.tpl}
				...
				{if isset($customizedDatas.$productId.$productAttributeId)}
					...
					{if $product.quantity-$quantityDisplayed > 0}{include file=$tpl_dir./modules/wishlist/wishlist-product-line.tpl}{/if}
				{/if}
			{/foreach}
			</tbody>
		</table>
