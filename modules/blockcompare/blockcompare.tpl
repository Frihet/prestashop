			...
			{if $products}
				...
				{foreach from=$products item='product' name='myLoop'}
					...
					<dt id="compare_block_product_{$productId}" class="{if $smarty.foreach.myLoop.first}first_item{elseif $smarty.foreach.myLoop.last}last_item{else}item{/if}">
						...
						<span class="remove_link"><a class="ajax_compare_block_remove_link" href="{$base_dir}compare.php?delete&amp;id_product={$productId}&amp;token={$static_token}" title="{l s='remove this product from my compare' mod='blockcompare'}">&nbsp;</a></span>
					</dt>
